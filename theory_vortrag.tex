\begin{frame}{Theory: Topological insulator}
	...
	3D topological insulators are distinguishable into strong and weak ones where the number of Dirac cones is odd for strong and even for weak ones. HgTe normally is a semi metal but under strain its $\Gamma_6$ and $\Gamma_8$ bands can close up at Fermi level, which means its surface states become topological.}
\end{frame}
...
%	Here you can see the basis of it and a picture of a cubic. This is the basis for the bulk calculations. \\
...
\begin{frame}{Theory: Crystal and surface description part 2}
	\begin{columns}
		\begin{column}<3->{.6\linewidth}
			Reciprocal lattice: 
			\begin{equation*}
				e^{i\boldsymbol{K}\boldsymbol{R}} = 1
			\end{equation*}
